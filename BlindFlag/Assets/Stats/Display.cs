...
public class Display : MonoBehaviour
{
    private void OnGUI()
    {
        ...
        GUI.Box(new Rect(25, 160, 150, 25), "BlindCaptain's STATS");
        GUI.Box(new Rect(25, 186, 150, 25), "HP: " + BlindCaptain_Stat.HP + " / " + BlindCaptain_Stat.Max_HP);
        GUI.Box(new Rect(25, 212, 150, 25), "Lvl: " + BlindCaptain_Stat.Lvl);
        GUI.Box(new Rect(25, 238, 150, 25), "XP: " + BlindCaptain_Stat.XP + " / " + BlindCaptain_Stat.Max_XP);
    }
}
